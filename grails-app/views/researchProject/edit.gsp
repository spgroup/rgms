...
<html>
	...
	<body>
		<a href="#edit-researchProject" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-researchProject" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${researchProjectInstance?.version}" />
				<fieldset class="form">
