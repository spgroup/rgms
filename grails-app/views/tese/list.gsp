...
<body>
<a href="#list-tese" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div class="nav" role="navigation">
    <ul>
        ...
        <li><g:link class="search" action="search"><g:message code="default.search.label"
                                                              args="[entityName]"/></g:link></li>
    </ul>
</div>
        ...
        <g:each in="${teseInstanceList}" status="i" var="teseInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${teseInstance.id}">${fieldValue(bean: teseInstance, field: "title")}</g:link></td>
