    ...
    <form id="log" action="auth/signIn" method="post">
        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="username" required="true" value=""
            ...
            <tr>
                ...
                <td><input type="password" name="password" required="true" value=""
                           style="font-size: 12px; font-weight: bold; border: solid 1px #d0d0d0; height: 23px; width: 250px;"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td></td>
                <td><span><input type="submit" name="signIn" id="signIn" value="Sign In"
                ...
                </span><span style="float: right;"><input id="rememberMe" type="checkbox"
                                                          name="rememberMe"/> Remember me?<br/><a
                        href="auth/lostPassword">I have lost my password</a><br/><a
                        href="auth/register">Create an account</a></span></td> <!--#1c94cd-->
            </tr>
            </tbody>
        </table>
    </form>
