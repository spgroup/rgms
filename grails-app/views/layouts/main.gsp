...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	<head>
		...
		<link rel="apple-touch-icon" href="${resource(dir: 'images', file: 'icon.png')}"> <!-- apple-touch-icon.png -->
		<link rel="apple-touch-icon" sizes="114x114" href="${resource(dir: 'images', file: 'icon.png')}"> <!-- apple-touch-icon-retina.png -->
