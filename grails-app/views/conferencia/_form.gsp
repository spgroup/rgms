...
<!-- #if( $contextualInformation ) -->
     <g:select name="members" from="${PublicationController.membersOrderByUsually()}" size="10" multiple="yes" optionKey="id" value="${conferenciaInstance?.members}"/>
<!-- #else <g:select name="members" from="${Member.list()}" size="10" multiple="yes" optionKey="id" value="${conferenciaInstance?.members}"/> -->
<!-- #end -->
